/**
 * In the static block, we set the different access control to specific tasks, e.g. a USER
 * can DO_WORK etc.
 * 
 * The method getAccessControl() returns the AccessControl object specific to the controlLevel
 * passed in as a parameter. Example, a 'USER' String returns an object with 'DO_WORK'
 * 
 */
